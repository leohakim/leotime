...
26. [Profile settings API](docs/26-profile-settings-api.md)
27. [Offline queue MVP](docs/27-offline-queue-mvp.md)
28. [Email notifications](docs/29-email-notifications.md)
29. [ADR 0001: Stack decision](docs/adr/0001-stack-go-sqlite-react.md)
30. [ADR 0002: In-process scheduler](docs/adr/0002-in-process-scheduler-outbox.md)
