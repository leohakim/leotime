...
Remaining follow-ups: [H-BACKUP-04](../35-curated-hardening-backlog.md#h-backup-04--restore-database-and-documents-safely-together) for rollback-safe restore, richer fiscal series admin UI, client-level defaults in the dashboard, and any legal/compliance features explicitly out of scope here. Issuance invariants and document atomicity were completed in [H-INV-01](../35-curated-hardening-backlog.md#h-inv-01--fiscal-issue-invariants-and-document-atomicity) (2026-07-11).
